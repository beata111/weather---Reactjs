  ...
  if (props.weatherPanel.inputType === 'city') {
    return(
      <div className="row">
        <div className="col-sm-2">
          <button className="btn btn-success weather-btn" onClick={()=>context.getWeatherFromCityName($('#weather-input-city')[0].value)}>go!</button>
        </div>
        <div className="col-sm-10 weather-input">
    ...
    return(
      <div>
        <div className="row">
          <div className="col-sm-2">
            <button className="btn btn-success weather-btn"
          ...
          <div className="col-sm-10 weather-input">
            <div className="row">
              ...
              <div className="col-xs-2">
                <select className="coordinate-select" id="first-coordinate-sign">
              ...
              <div className="col-xs-2">
                <select className="coordinate-select" id="second-coordinate-sign">
        ...
        <div className="row">
          <div className="col-xs-12">
            <button className="btn btn-success weather-btn mt20"
